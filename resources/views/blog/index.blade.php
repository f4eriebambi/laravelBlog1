...
@else
    <!-- Display posts -->
    <div class="w-4/5 m-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 py-16">
        @foreach ($posts as $post)
            <div class="blog-card relative flex flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md h-full">
    <!-- Media section -->
    ...
    <div class="p-6 flex-grow">
        <h5 class="mb-2 text-lg font-semibold leading-snug text-gray-800 line-clamp-2">
            {{ $post->title }}
        </h5>
